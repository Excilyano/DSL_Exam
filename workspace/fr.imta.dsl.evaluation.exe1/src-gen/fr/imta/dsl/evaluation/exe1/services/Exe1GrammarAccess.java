...
* generated by Xtext
*/
package fr.imta.dsl.evaluation.exe1.services;
...
@Singleton
public class Exe1GrammarAccess extends AbstractGrammarElementFinder {
	...
	@Inject
	public Exe1GrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("fr.imta.dsl.evaluation.exe1.Exe1".equals(grammar.getName())) {
				return grammar;
			}
