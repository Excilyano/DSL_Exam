...
import fr.imta.dsl.evaluation.exe1.exe1.Exe1Factory;
 ...
 * @generated
 */
public class Exe1PackageImpl extends EPackageImpl implements Exe1Package
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.imta.dsl.evaluation.exe1.exe1.Exe1Package#eNS_URI
   * @see #init()
   * @generated
   */
  private Exe1PackageImpl()
  {
    super(eNS_URI, Exe1Factory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link Exe1Package#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static Exe1Package init()
  {
    if (isInited) return (Exe1Package)EPackage.Registry.INSTANCE.getEPackage(Exe1Package.eNS_URI);

    // Obtain or create and register package
    Exe1PackageImpl theExe1Package = (Exe1PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Exe1PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Exe1PackageImpl());

    isInited = true;

    // Create package meta-data objects
    theExe1Package.createPackageContents();

    // Initialize created meta-data
    theExe1Package.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theExe1Package.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(Exe1Package.eNS_URI, theExe1Package);
    return theExe1Package;
  }
   ...
   * @generated
   */
  public Exe1Factory getExe1Factory()
  {
    return (Exe1Factory)getEFactoryInstance();
  }
