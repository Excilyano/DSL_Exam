...
public class Exe4Generator implements IGenerator {
  ...
  public CharSequence generateProgram(final Model m) {
    ...
    _builder.newLine();
    {
      ...
      for(final Frame f : _frames) {
        _builder.append("\t\t\t\t");
        _builder.append("final JFrame ");
        String _name = f.getName();
        _builder.append(_name, "				");
        _builder.append(" = new JFrame(); // Annotation \"final\" necessaire sur mon poste");
        _builder.newLineIfNotEmpty();
      }
    }
    {
      EList<Frame> _frames_1 = m.getFrames();
      for(final Frame f_1 : _frames_1) {
        _builder.append("\t\t\t\t");
        CharSequence _generate = this.generate(f_1);
        _builder.append(_generate, "				");
        _builder.newLineIfNotEmpty();
      }
    }
    _builder.append("\t\t\t\t");
    EList<Frame> _frames_2 = m.getFrames();
    Frame _get = _frames_2.get(0);
  ...
  public CharSequence generate(final Frame f) {
    ...
    _builder.newLineIfNotEmpty();
    {
      ...
      for(final Component c : _components) {
        ...
        CharSequence _generateComponent = this.generateComponent(c, _name_5, _indexOf);
  ...
  protected CharSequence _generateComponent(final Button b, final String fName, final int i) {
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    _builder.append("//@Override // --> Fonctionne sans l\'annotation sur mon poste, decommenter sinon");
    _builder.newLine();
    _builder.append("\t");
