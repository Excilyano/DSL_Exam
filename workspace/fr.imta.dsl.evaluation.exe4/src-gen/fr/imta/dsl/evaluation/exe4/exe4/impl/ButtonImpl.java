 ...
 * <ul>
 *   <li>{@link fr.imta.dsl.evaluation.exe4.exe4.impl.ButtonImpl#getDest <em>Dest</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ButtonImpl extends ComponentImpl implements Button
{
  ...
  {
    return Exe4Package.Literals.BUTTON;
  }
    ...
    if (dest != null && dest.eIsProxy())
    {
      ...
      if (dest != oldDest)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, Exe4Package.BUTTON__DEST, oldDest, dest));
      }
    }
    return dest;
  }
  ...
  public void setDest(Frame newDest)
  {
    ...
    dest = newDest;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Exe4Package.BUTTON__DEST, oldDest, dest));
  }
